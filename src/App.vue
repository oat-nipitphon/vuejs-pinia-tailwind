...
//     testAPI.value = await response.json();
//     console.log(testAPI.value);
//   } catch (error) {
//     console.error("Error fetching data:", error);
//     testAPI.value = { message: "Error fetching data." };
//   }
// });
</script>
          ...
          >
            ...
            <!-- <li>
              <button
                ...
                class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded md:w-auto hover:bg-gray-100 md:hover:bg-transparent md:border-0
                 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent
